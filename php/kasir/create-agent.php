...
<head>
  ...
  <title>Create Agent | CharaDrink</title>
  ...
  <div class="admin-shell">
    ...
    <aside class="admin-sidebar" id="adminSidebar" aria-label="Main navigation">
      ...
      <nav class="sidebar-nav">
        ...
        <a class="nav-link active" href="create-agent.php" aria-current="page">
      ...
      <nav class="navbar admin-navbar navbar-expand bg-white">
        <div class="container-fluid px-3 px-lg-4">
          ...
          <form class="d-none d-md-flex ms-3 flex-grow-1" role="search">
            <input class="form-control search-input" type="search" placeholder="Search agents, teams, reports" aria-label="Search">
          </form>
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end notification-menu">
                ...
                <a class="dropdown-item" href="users.php">
                  <span class="notification-title">Agent created successfully</span>
                  <span class="notification-time">2 minutes ago</span>
                </a>
                <a class="dropdown-item" href="charts.php">
                  <span class="notification-title">Agent performance updated</span>
                  <span class="notification-time">15 minutes ago</span>
                </a>
                <a class="dropdown-item" href="settings.php">
                  <span class="notification-title">New agent template available</span>
      ...
      <main class="dashboard-content">
        <div class="container-fluid px-3 px-lg-4 py-4">
          <div class="page-heading">
            ...
            <div class="heading-actions"><a class="btn btn-outline-secondary btn-sm" href="users.php"><i class="bi bi-arrow-left" aria-hidden="true"></i> Back</a></div>
          </div>
          ...
          <section class="row g-3">
            <div class="col-12 col-xl-8">
              <form class="panel needs-validation" novalidate>
                ...
                <div class="d-flex flex-wrap justify-content-end gap-2 mt-4"><a class="btn btn-outline-secondary" href="users.php">Cancel</a><button class="btn btn-primary" type="submit"><i class="bi bi-check-circle" aria-hidden="true"></i> Create Agent</button></div>
              </form>
            </div>
