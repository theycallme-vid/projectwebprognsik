...
<head>
  ...
  <title>500 Server Error | CharaDrink</title>
...
<body class="auth-body">
  ...
  <main class="error-page">
    <section class="error-card">
      ...
      <img class="error-illustration" src="../assets/images/svg/maintenance.svg" alt="Maintenance illustration">
      ...
      <div class="d-flex flex-wrap justify-content-center gap-2"><a class="btn btn-primary" href="Dashboard.php"><i class="bi bi-speedometer2" aria-hidden="true"></i> Back to Dashboard</a><a class="btn btn-outline-secondary" href="Dashboard.php">Sign In</a></div>
    </section>
  </main>
