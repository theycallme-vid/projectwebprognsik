...
<head>
  ...
  <title>Profile | CharaDrink</title>
  ...
  <div class="admin-shell">
    ...
    <aside class="admin-sidebar" id="adminSidebar" aria-label="Main navigation">
      ...
      <nav class="sidebar-nav">
        ...
        <a class="nav-link active" href="profile.php" aria-current="page">
          ...
          <section class="row g-3">
            <div class="col-12 col-xl-4">
              <div class="panel h-100 text-center profile-card">
                ...
                <div class="info-list mt-4 text-start"><div><span>Email</span><strong>admin@example.com</strong></div><div><span>Department</span><strong>Product Ops</strong></div><div><span>Time Zone</span><strong>Asia/Dhaka</strong></div></div>
              </div>
            </div>
            <div class="col-12 col-xl-8">
              <form class="panel needs-validation" novalidate>
                ...
                <div class="row g-3"><div class="col-md-6"><label class="form-label" for="profileName">Name</label><input class="form-control" id="profileName" type="text" value="Admin Hasan" required><div class="invalid-feedback">Name is required.</div></div><div class="col-md-6"><label class="form-label" for="profileEmail">Email</label><input class="form-control" id="profileEmail" type="email" value="admin@example.com" required><div class="invalid-feedback">Enter a valid email.</div></div><div class="col-12"><label class="form-label" for="profileBio">Bio</label><textarea class="form-control" id="profileBio" rows="5">Focused on clean admin workflows, reusable UI systems, and reliable operations.</textarea></div></div>
